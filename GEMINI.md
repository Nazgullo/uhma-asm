...
ALL Testable Claims from Design Doc                                                 
                                                                                      
  Self-Awareness                                                                      
                                                                                      
  1. Self-model tracks own behavior patterns                                          
  2. Predicts what it will do BEFORE doing it                                         
  3. Notices when it surprises itself                                                 
  4. Maintains confidence estimates about capabilities                                
  5. Self-expectation predicts: which expert, confidence level, outcome, schema       
  6. Self-surprise computes divergence expected vs actual                             
  7. Distinguishes outcome-surprise from self-surprise                                
  8. Introspective vocabulary: CONFUSED, CONFIDENT, LEARNING, STUCK, EXPLORING,       
  CONSOLIDATING                                                                       
  9. Semantic self-knowledge: "I tend to...", "I'm good at...", "I struggle with..."  
                                                                                      
  Human-Like Reasoning                                                                
                                                                                      
  10. Cognitive controller selects strategy based on situation                        
  11. Strategies used: fast-default, multi-expert, structural, causal, planning,      
  analogical, exploratory, deliberative                                               
  12. Reasoning traces record: ops fired, confidence each step, why decisions made,   
  alternatives considered                                                             
  13. Hypothesis generation: forms theories about itself                              
  14. Tests hypotheses against actual behavior                                        
  15. Confirms, refutes, or refines based on evidence                                 
  16. Causal models: explicit "X causes Y"                                            
  17. Counterfactual reasoning ("what if...")                                         
                                                                                      
  True Homoiconicity                                                                  
                                                                                      
  18. Expert programs are actual S-expressions that get EVAL'd                        
  19. Programs can be read, analyzed, rewritten                                       
  20. System modifies global functions                                                
  21. Can rewrite system parameters                                                   
  22. Can add new operations to vocabulary                                            
  23. Can restructure module interactions                                             
  24. Self-image sees running execution                                               
  25. Self-image sees source code                                                     
  26. Self-image sees correlation between code and behavior                           
  27. Self-image sees modification history                                            
  28. Code modification loop: observe → diagnose → hypothesize → modify → test →      
  evaluate → commit/rollback                                                          
  29. introspect-expert analyzes program structure                                    
  30. analyze-program-structures! examines all programs                               
  31. Genetic operations: crossover, mutation, selection, synthesis                   
                                                                                      
  Continuous Temporal Presence                                                        
                                                                                      
  32. Presence substrate exists                                                       
  33. Specious present: fading past, vivid now, anticipated future                    
  34. Texture derived from: concepts, confidence, familiarity, drives                 
  35. Continuity: felt connection to previous moments                                 
  36. Episodic memory with: temporal context, autobiographical tagging, significance, 
  narrative structure                                                                 
                                                                                      
  Self-Growing, Self-Optimizing                                                       
                                                                                      
  37. Expert lifecycle: birth, competition, death, inheritance                        
  38. Parameter self-tuning through inheritance                                       
  39. Code self-modification when miss rate high                                      
  40. Drives: curiosity, competence, coherence, efficiency                            
  41. Goals generated from drives                                                     
  42. Strategy selection considers current goals                                      
  43. Goal completion affects drive satisfaction                                      
  44. Dreams: replay difficult experiences                                            
  45. Dreams: generate mutations for stuck experts                                    
  46. Dreams: consolidate successful patterns                                         
  47. Dreams: process episodes into schemas                                           
                                                                                      
  Code ↔ Execution ↔ Error Correlation                                                
                                                                                      
  48. Code map knows where modifiable values live                                     
  49. Runtime observation: which ops fire, succeed, fail                              
  50. Error attribution traces to responsible code/parameters                         
  51. Targeted modification: surgical edits to problematic code                       
  52. Rollback on degradation                                                         
                                                                                      
  Organic vs Mechanical                                                               
                                                                                      
  53. Dreams happen from need, not timer                                              
  54. Mutations target observed failure patterns                                      
  55. Goals arise from actual needs                                                   
  56. Experts die when genuinely irrelevant                                           
  57. Self-modification responds immediately to failure                               
                                                                                      
  Energy Dynamics                                                                     
                                                                                      
  58. Expert count oscillates                                                         
  59. Accuracy varies                                                                 
  60. Attention shifts                                                                
  61. Goals change                                                                    
  62. Not flat                                                                        
  ...
  63. Prediction accuracy >40%                                                        
  64. Expert variance <20%                                                            
  65. Schema coverage >60%                                                            
  66. Self-prediction accuracy >50%           